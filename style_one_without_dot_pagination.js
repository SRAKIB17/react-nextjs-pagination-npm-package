...
exports.Style_one_without_dot_pagination = void 0;
var Style_one_without_dot_pagination = function (_a) {
    ...
    var getPageArray = lastPage > 10 ? __spreadArray([], Array(lastPage).keys(), true).slice(((current_page - 5 <= 0 ? 0 : current_page - 5)), (current_page - 5 >= 0 ? current_page + 4 : 10)) : __spreadArray([], Array(lastPage).keys(), true);
...
exports.Style_one_without_dot_pagination = Style_one_without_dot_pagination;
